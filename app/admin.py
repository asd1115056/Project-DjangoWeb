...
from .models import env_info ,pet_info ,user_setting ,Tag_Info ,food_type
...
class user_settingAdmin(admin.ModelAdmin):
    list_display = ('Tag','schedule_time','food_ammount','created_at')
    #後台要顯示的資料表格
...
class food_typeAdmin(admin.ModelAdmin):
    list_display = ('Name','kCal','updated_at','created_at')
    #後台要顯示的資料表格
