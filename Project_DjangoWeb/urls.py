...
urlpatterns = [path('', views.home, name='home'),
    ...
    path('ajax/control_input', views.control_input, name='control_input'),
    path('api/control_output', views.control_output, name='control_output'),
    path('ajax/control', views.control, name='control'),
    path('login/',
